...
class Contact extends Component {
  ...
  onSend(e) {
    let tags = this.mainContainer.getElementsByTagName("*");
    let rowData = Helper.getAllValuesEl(tags);
    document.getElementById('success_message').textContent = JSON.stringify(rowData);
  }

  render() {
    return (
      <div className="container" ref={(mainContainer) => { this.mainContainer = mainContainer }}>
        <div className="form-horizontal" id="contact_form">
          <fieldset>
            ...
            <div className="form-group">
              ...
              <div className="col-md-4">
                <div className="radio">
                  <label>
                    <input type="radio" name="hosting" value="yes" checked /> Yes
                    </label>
                </div>
                <div className="radio">
                  <label>
            ...
            <div className="form-group">
              ...
              <div className="col-md-4">
                <button type="submit" onClick={this.onSend.bind(this)} className="btn btn-warning" >Send <span className="glyphicon glyphicon-send"></span></button>
              </div>
            </div>
